...
public class SearchActivity extends AppCompatActivity {
    ...
    private void fetchArticles(Query query) {
        ...
        if(!TextUtils.isEmpty(query.getBegin_date())) params.put("begin_date", query.getBegin_date());
        if(!TextUtils.isEmpty(query.getSort())) params.put("sort", query.getBegin_date());
